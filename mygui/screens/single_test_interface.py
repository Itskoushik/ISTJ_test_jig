...
class SingleTestScreen(QMainWindow):
    ...
    def __init__(self, selected_tests=None,previous_screen=None, entry_mode="station"):
        super().__init__()
    ...
    def apply_entry_mode(self):
        ...
        # ===============================
            ...
            self.jbox_combo.setCurrentText("ALH4")
            self.jbox_combo.setEnabled(False)
    ...
    def run_psu_automation_with_jbox(self):
        try:
            ...
            self.check_abort()
            jb_seq_s.run_norm(self)
            time.sleep(0.5)
            jb_seq_s.run_stby(self)
            time.sleep(0.5)
    ...
    def run_psu_automation_no_jbox(self):
        try:
            ...
            tests_to_run = self.selected_tests or [
                "microphone_audio",
                "phones_audio",
                "mic_limiter",
                "vos_delay",
